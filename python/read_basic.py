...
def read_results(name):
    ...
    with open ("results/"+ name + '.pkl', "rb") as fin:       
        ...
        results["4_res_x"] = pickle.load(fin)   
        results["5_res_capacity"] = pickle.load(fin)   
        results["res_y"] = pickle.load(fin)   
        
        results["6_res_emission"] = pickle.load(fin)     
        
        results["7_res_c_total"] = pickle.load(fin)          
        ...
        results["res_revenue"] = pickle.load(fin)   
        results["res_subsidy"] = pickle.load(fin)               
        ...
        results["res_x_restruc"] = pickle.load(fin)   
        results["res_Ht"] = pickle.load(fin)   
        results["res_Qs"] = pickle.load(fin)   
        results["res_Qp_DIN"] = pickle.load(fin)   
